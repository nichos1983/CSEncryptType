...
namespace CitrusUtils
{
    ...
    public class EncryptInt : EncryptTypeBase<int, int, EncryptInt>
    {
        ...
        protected override int DecodeValue(int value, int key) => (int)(value ^ key);
        protected override int EncodeValue(int v, int key) => (int)(v ^ key);
    ...
    public class EncryptUInt : EncryptTypeBase<uint, uint, EncryptUInt>
    {
        ...
        protected override uint DecodeValue(uint value, uint key) => (uint)(value ^ key);
        protected override uint EncodeValue(uint v, uint key) => (uint)(v ^ key);
    ...
    {
        protected override long GetInitKey(int rand) => (long)rand;
        protected override long DecodeValue(long value, long key) => (long)(value ^ key);
        protected override long EncodeValue(long v, long key) => (long)(v ^ key);
    ...
    public class EncryptULong : EncryptTypeBase<ulong, ulong, EncryptULong>
    {
        ...
        protected override ulong DecodeValue(ulong value, ulong key) => (ulong)(value ^ key);
        protected override ulong EncodeValue(ulong v, ulong key) => (ulong)(v ^ key);
